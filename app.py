        ...
        dbc.CardBody([
            dash_table.DataTable(
                ...
                style_data_conditional=[
                    {'if': {'column_id': 'Priority', 'filter_query': '{Priority_lower} = "high"'},
                     'backgroundColor': '#ffe5e5'},
                    {'if': {'column_id': 'Status', 'filter_query': '{Status_lower} = "not started"'},
                     'backgroundColor': '#fff6cc'},
                    {'if': {'column_id': 'Status', 'filter_query': '{Status_lower} = "complete"'},
